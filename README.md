...
**AGREEMENT TO TERMS**  
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Farid Karioty (“we,” “us” or “our”), concerning your access to and use of the Photo Cine Copilot App as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “App”). You agree that by accessing the App, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE APP AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
Copy or adapt the App’s software, including but not limited to Java, Dart, or other code.
...
**GOVERNING LAW**  
These Terms of Use and your use of the App are governed by and construed in accordance with the laws of France. In the event of a dispute and in the absence of an amicable agreement, the dispute will be brought before the courts of the judicial district of our head office.
...
**CONTACT US**  
In order to resolve a complaint regarding the Site or to receive further information regarding use of the App, please contact us at: photocinecopilot@gmail.com.
